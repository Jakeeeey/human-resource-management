...
import {
    ...
    saveDesign,
    type MsDesignRow,
} from "@/modules/human-resource-management/mailing-studio/services/design-persistence-service";
...
import {
    MS_BODY_HTML_MAX,
    MS_DESIGN_JSON_MAX,
} from "@/modules/human-resource-management/mailing-studio/types/ms-template.schema";
