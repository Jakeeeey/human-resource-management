...
async function proxy(req: NextRequest) {
  ...
  let upstreamUrl = `${UPSTREAM_BASE.replace(/\/+$/, "")}/items/company_memo_attachments`;
  ...
  try {
    ...
    if (!res.ok) {
        ...
        console.error(`[Attachments Proxy] Upstream Error (${res.status}):`, errorBody);
    ...
    console.error(`[Attachments Proxy] Connection Error:`, message);
