...
async function proxy(req: NextRequest) {
  ...
  let upstreamUrl = `${UPSTREAM_BASE.replace(/\/+$/, "")}/items/company_list`;
  ...
  try {
    ...
    if (!res.ok) {
        ...
        console.error(`[Company List Proxy] Upstream Error (${res.status}):`, errorBody);
    ...
    console.error(`[Company List Proxy] Connection Error:`, message);
