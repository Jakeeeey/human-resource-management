...
async function proxy(req: NextRequest) {
    ...
    let upstreamUrl = `${UPSTREAM_BASE.replace(/\/+$/, "")}/items/manu_hr_lines`;
    ...
    try {
        ...
        if (!res.ok) {
            ...
            console.error(`[Manufacturing - Lines Proxy] Upstream Error (${res.status}):`, errorBody);
        ...
        console.error(`[Manufacturing - Lines Proxy] Connection Error:`, message);
