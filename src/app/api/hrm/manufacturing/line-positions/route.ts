...
async function proxy(req: NextRequest) {
    ...
    let upstreamUrl = `${UPSTREAM_BASE.replace(/\/+$/, "")}/items/manu_hr_line_positions`;
    ...
    try {
        ...
        if (!res.ok) {
            ...
            console.error(`[Manufacturing - Line Positions Proxy] Upstream Error (${res.status}):`, errorBody);
        ...
        console.error(`[Manufacturing - Line Positions Proxy] Connection Error:`, message);
