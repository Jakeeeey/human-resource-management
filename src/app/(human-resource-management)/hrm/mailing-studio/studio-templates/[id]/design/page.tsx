...
import { DesignerPage } from "@/modules/human-resource-management/mailing-studio/studio-templates/designer";
        ...
        return (
            <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                            ...
                            <Breadcrumb>
                                <BreadcrumbList className="min-w-0 overflow-hidden">
                                    <BreadcrumbItem className="hidden md:block shrink-0">
                                        <BreadcrumbLink href="/hrm/mailing-studio/studio-templates">Mailing Studio</BreadcrumbLink>
                                    </BreadcrumbItem>
                                    <BreadcrumbSeparator className="hidden md:block shrink-0" />
                                    <BreadcrumbItem className="hidden md:block shrink-0">
                                        <BreadcrumbLink href="/hrm/mailing-studio/studio-templates">Templates</BreadcrumbLink>
                                    </BreadcrumbItem>
                                    <BreadcrumbSeparator className="hidden md:block shrink-0" />
                ...
                <main className="flex min-h-0 min-w-0 flex-1 overflow-hidden">
                    <DesignerPage templateKey={templateKey} />
                </main>
            </div>
        );
    }
                ...
                <div className="flex min-h-0 flex-1 flex-col overflow-y-auto p-4 sm:p-6">
                    <div className="mx-auto flex w-full max-w-3xl flex-col items-center gap-3 rounded-lg border bg-card py-16 text-center">
                        ...
                        <Button size="sm" asChild>
                            <Link href="/hrm/mailing-studio/studio-templates">Back to templates</Link>
                        </Button>
                    </div>
                </div>
            </main>
