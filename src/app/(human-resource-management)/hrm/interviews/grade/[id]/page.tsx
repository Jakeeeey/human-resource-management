...
import { GradeInterviewClient } from "./grade-client";
...
export const metadata = {
    title: "Grade Interview | HRM",
    description: "Score a scheduled applicant interview",
};
...
export default async function GradeInterviewServerPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="/hrm/interviews">Interviews</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-hidden p-6 md:p-8 overflow-y-auto">
                <GradeInterviewClient interviewId={Number.isNaN(interviewId) ? null : interviewId} />
            </main>
        </div>
    );
}
