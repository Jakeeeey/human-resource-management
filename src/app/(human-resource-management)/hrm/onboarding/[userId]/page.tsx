...
export const metadata = {
  title: "Onboarding Workspace | HRM",
  description:
    "Per-hire onboarding workspace: phased tasks and the documents, orientation, training, equipment, and completion surfaces.",
};
...
export default async function OnboardingWorkspacePage({
  ...
  const operator = resolveOnboardingOperator(
            ...
            <Breadcrumb>
              <BreadcrumbList className="min-w-0 overflow-hidden">
                <BreadcrumbItem className="hidden md:block shrink-0">
                  <BreadcrumbLink href="/hrm/onboarding">
                    Onboarding
                  </BreadcrumbLink>
                </BreadcrumbItem>
