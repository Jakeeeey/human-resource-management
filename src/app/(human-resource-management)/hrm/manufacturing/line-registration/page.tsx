...
import { LineRegistrationModule } from "@/modules/human-resource-management/manufacturing/line-registration";
...
export const metadata = {
    title: "Line Registration | VOS ERP",
    description: "Register and manage manufacturing production lines and their positions.",
};
...
export default async function LineRegistrationPage() {
