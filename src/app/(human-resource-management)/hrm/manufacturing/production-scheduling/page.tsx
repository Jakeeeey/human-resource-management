...
import { ProductionSchedulingModule } from "@/modules/human-resource-management/manufacturing/production-scheduling";
...
export const metadata = {
    title: "Production Scheduling | VOS ERP",
    description: "Plan daily production runs, set targets, configure headcounts, and handle operational approvals.",
};
