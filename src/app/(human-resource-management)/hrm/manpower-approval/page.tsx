...
import { ManpowerApprovalModule } from "@/modules/human-resource-management/employee-admin/manpower-approval/ManpowerApparovalModule";
...
export const metadata = {
    title: "Manpower Approval | VOS ERP",
    description: "Manage departmental manpower approvals.",
};
...
export default async function ManpowerRequestServerPage() {
