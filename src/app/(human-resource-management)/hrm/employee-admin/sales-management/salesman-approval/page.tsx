...
import { SalesmanApprovalModule } from "@/modules/human-resource-management/employee-admin/sales-management/salesman-approval/SalesmanApprovalModule";
import { SalesmanApprovalProvider } from "@/modules/human-resource-management/employee-admin/sales-management/salesman-approval/providers/SalesmanApprovalProvider";
  ...
  return (
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
          <SalesmanApprovalProvider>
              <SalesmanApprovalModule />
          </SalesmanApprovalProvider>
        </main>
      </div>
  );
