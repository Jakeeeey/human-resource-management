...
import { DepartmentAccountsModule } from "@/modules/human-resource-management/employee-admin/structrure/department-accounts";
                ...
                <div className="flex h-full items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage>Department Accounts</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
