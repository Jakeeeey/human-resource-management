...
import { DepartmentScheduleModule } from "@/modules/human-resource-management/employee-admin/structrure/department-schedule";
                ...
                <div className="flex h-full items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage>Department Schedule</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
