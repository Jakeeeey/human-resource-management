...
import UndertimeTopsheetModule from "@/modules/human-resource-management/employee-admin/report/undertime-topsheet/UndertimeTopsheetModule";
...
export default async function UndertimeTopsheetPage() {
