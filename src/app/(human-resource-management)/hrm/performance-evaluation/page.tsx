...
import { PerformanceEvaluationModule } from "@/modules/human-resource-management/performance-evaluation";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export const metadata = {
  title: "Performance Evaluation | HRM",
  description: "HR roster of probation evaluations across departments.",
};
