// src/app/(human-resource-management)/hrm/file-management/employment-status-registration/page.tsx
import {
    Breadcrumb,
    BreadcrumbItem,
    BreadcrumbLink,
...
import { EmploymentStatusRegistrationModule } from "@/modules/human-resource-management/file-management/employment-status";
    ...
    return (
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
                <EmploymentStatusRegistrationModule />
            </main>
        </div>
    );
}
