...
import MemoAcknowledgementModule from "@/modules/human-resource-management/memo-management/memo-acknowledgement";
...
export const metadata = {
    title: "Memo Acknowledgement | VOS ERP",
    description: "Track target company acknowledgements of released memos.",
};
...
export default async function MemoAcknowledgementPage() {
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Memo Management</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
