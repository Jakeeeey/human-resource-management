...
import MemoReleasingModule from "@/modules/human-resource-management/memo-management/memo-releasing";
...
export const metadata = {
    title: "Memo Releasing | VOS ERP",
    description: "Release and synchronize approved memos.",
};
...
export default async function MemoReleasingPage() {
