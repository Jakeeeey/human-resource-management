...
import MemoSummaryModule from "@/modules/human-resource-management/memo-management/memo-summary";
...
export const metadata = {
    title: "Memo Summary | VOS ERP",
    description: "View history and summary logs of all company memos.",
};
...
export default async function MemoSummaryPage() {
