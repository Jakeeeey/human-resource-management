...
import { MemoCreationModule } from "@/modules/human-resource-management/memo-management/memo-creation";
...
export const metadata = {
    title: "Memo Creation | VOS ERP",
    description: "Create and manage memos.",
};
...
export default async function MemoCreationPage() {
