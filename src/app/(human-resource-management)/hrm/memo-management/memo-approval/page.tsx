...
import MemoApprovalModule from "@/modules/human-resource-management/memo-management/memo-approval";
...
export const metadata = {
    title: "Memo Approval | VOS ERP",
    description: "Approve or reject submitted memos.",
};
...
export default async function MemoApprovalPage() {
