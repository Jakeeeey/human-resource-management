...
import HandbookPage from "@/modules/human-resource-management/handbook/HandbookPage";
...
export const metadata = {
    title: "Company Handbook | VOS ERP",
    description: "Manage company handbooks and policies.",
};
...
export default async function HandbookServerPage() {
