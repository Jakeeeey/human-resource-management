...
import { ManpowerRecommendationModule } from "@/modules/human-resource-management/recruitment/manpower-recommendation";
...
export const metadata = {
    title: "Manpower Recommendations | HRM",
    description: "Manage applicant recommendations for open manpower requests",
};
...
export default async function ManpowerRecommendationServerPage() {
