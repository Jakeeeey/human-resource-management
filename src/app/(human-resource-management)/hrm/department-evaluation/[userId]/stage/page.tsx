...
export const metadata = {
  title: "Evaluation Stage | HRM",
  description: "Department-head per-employee evaluation stage form: KPI sheet, PIP, or recommendation.",
};
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
        <Suspense>
          <EvaluationStageView scope="head" userId={userId} />
        </Suspense>
      </main>
    </div>
  );
