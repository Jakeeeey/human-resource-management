...
import { Paperclip, MoreVertical, Eye, ChevronLeft, ChevronRight } from "lucide-react";
...
interface MemoSummaryTableProps {
    data: Memo[];
    companies: Company[];
...
export function MemoSummaryTable({
    data,
    companies,
    onView,
    isLoading,
