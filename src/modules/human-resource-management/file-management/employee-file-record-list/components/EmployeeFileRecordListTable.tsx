...
interface EmployeeFileRecordListTableProps {
...
export function EmployeeFileRecordListTable({
    data,
    recordTypes,
    isLoading = false,
    onCreateRecord,
    onUpdateRecord,
    onDeleteRecord,
}: EmployeeFileRecordListTableProps) {
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <EmployeeFileRecordListToolbar recordTypes={recordTypes} />
