...
import { fetchMsCatalog } from "./msCatalog";
...
/**
 * Lists event_catalog rows via the real catalog route. Data is null until
 * loaded; every mutation in CatalogTab refetches through refetch().
 */
