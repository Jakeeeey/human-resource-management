// T3 — idempotency key builders (READ-ONLY copy of recruitment/mailing
// utils/idempotency.ts — Appendix Idempotency keys row — formulas verbatim).
//
...
//
// The ms_outbox carries a unique index on idempotency_key: a repeated auto key
