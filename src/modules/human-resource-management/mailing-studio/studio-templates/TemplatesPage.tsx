                        ...
                        return (
                            ...
                            >
                                ...
                                <Button aria-label={`Open in designer: ${row.template_name}`} className="min-h-11 md:min-h-0" size="sm" asChild>
                                    <Link href={`/hrm/mailing-studio/studio-templates/${encodeURIComponent(row.template_key)}/design`}>
                                        Open in designer
                                    </Link>
                                </Button>
                                <Button aria-label={`Details for ${row.template_name}`} className="min-h-11 md:min-h-0" size="sm" variant="outline" asChild>
                                    <Link href={`/hrm/mailing-studio/studio-templates/${encodeURIComponent(String(ref))}`}>
                                        Details
                                    </Link>
                                </Button>
                            </li>
