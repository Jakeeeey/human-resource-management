  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div className="flex items-center justify-between bg-card p-4 rounded-xl border border-muted-foreground/10 shadow-sm">
        ...
        >
          <Plus className="mr-2 h-4 w-4" /> Assign Supervisor
        </Button>
      </div>
              ...
              <TableRow>
                <TableCell colSpan={4} className="h-64 text-center pointer-events-none">
                  <div className="flex flex-col items-center justify-center space-y-3 opacity-40">
                    ...
                    <p className="text-base font-medium">No supervisors assigned yet</p>
                    <p className="text-sm">Assigned supervisors will appear here.</p>
                  </div>
                </TableCell>
              </TableRow>
            ) : (
                ...
                return (
                  <TableRow key={item.id} className="group border-muted-foreground/10 hover:bg-muted/30 transition-colors">
                    <TableCell className="py-4 px-6">
                      <Badge variant="outline" className="bg-secondary/20 text-secondary-foreground border-secondary/30 px-3 py-1 font-bold text-[10px] tracking-wider uppercase">
