...
// TemplatesTablePagination.tsx — the always-rendered footer for the paperwork
// template table: the `Showing X–Y of Z` range, a page-size selector, and the
// page links. Prev/Next are inert at the bounds; the active page carries
...
// Mirrors the requirements module's `RequirementsTablePagination`.
...
interface TemplatesTablePaginationProps {
  page: number;
  pageSize: number;
  totalPages: number;
...
/**
 * Renders the pagination footer for the template table.
 * @param props Page state, derived range, and change handlers.
 * @returns The footer markup.
 */
export function TemplatesTablePagination({
  page,
  pageSize,
  totalPages,
  filteredCount,
